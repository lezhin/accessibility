...
4. [키보드 만으로 조작 가능하다.](#keyboard)
5. [사용할 수 있는 충분한 시간을 제공한다.](#time)
6. [발작을 유발하는 콘텐츠를 제공하지 않는다.](#seizure)
7. [반복되는 콘텐츠 블록을 건너뛸 수 있다.](#bypass)
8. [모든 문서의 제목은 고유하고 식별 가능하다.](#title)
9. [링크 텍스트는 콘텐츠의 목적을 알 수 있다.](#link)
10. [섹션에는 의미있는 마크업과 헤딩이 있다.](#outline)
11. [문서의 휴먼 랭귀지 속성을 제공한다.](#lang)
12. [예측 불가능한 문맥 변화가 발생하지 않는다.](#predict)
...
## 4. 키보드 만으로 조작 가능하다. <a id="keyboard" href="#keyboard">#</a>
...
## 8. 모든 문서의 제목은 고유하고 식별 가능하다. <a id="title" href="#title">#</a>
...
## 9. 링크 텍스트는 콘텐츠의 목적을 알 수 있다. <a id="link" href="#link">#</a>
* 주변 콘텐츠와 분리하여 독립적으로 접근해도 링크의 목적을 알 수 있어야 한다.
* 링크에 독립적으로 접근하여 이해하기 어려운 경우 동일한 단락, 목록, 셀, 연결된 헤더셀(p, li, td, th)에 링크의 목적을 설명해야 한다.
...
## 10. 섹션에는 의미있는 마크업과 헤딩이 있다. <a id="outline" href="#outline">#</a>
...
## 12. 예측 불가능한 문맥 변화가 발생하지 않는다. <a id="predict" href="#predict">#</a>
...
* '대한민국' 선택의 결과로 대한민국의 '시/군/구'를 선택하는 항목이 등장했다면 이것은 문맥 변화가 아니다.
